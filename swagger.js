...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Complete API documentation for Expense Tracker Backend. This API provides endpoints for user management, team management, expense tracking, category management, reports, and budget overview.',
      contact: {
        name: 'API Support',
    ...
    components: {
      securitySchemes: {
        bearerAuth: {
          ...
          scheme: 'bearer',
          bearerFormat: 'JWT',
          description: 'Enter your JWT token. Get your token by logging in or completing MFA setup.'
        }
      },
      schemas: {
        User: {
        ...
        Expense: {
          type: 'object',
          required: ['title', 'amount', 'category', 'description', 'date', 'createdBy'],
          properties: {
            _id: {
              type: 'string',
        ...
        Report: {
          type: 'object',
          required: ['team', 'category', 'totalAmount', 'periodStart', 'periodEnd', 'date'],
          properties: {
            _id: {
              type: 'string',
    ...
    tags: [
      {
        name: 'Users',
        description: 'User management and authentication endpoints including MFA setup'
      },
      {
        name: 'Teams',
